...
export const kanbanGrid = [
  {
    headerText: "کارهایی که باید انجام بشود",
    keyField: "Open",
    allowToggle: true,
  },
  ...
  { headerText: "تمام شده", keyField: "Close", allowToggle: true },
];
...
export const rangeColorMapping = [
  { label: "۱°C to ۱۰°C", start: "1", end: "10", colors: colorMappingData[1] },
...
export const employeesGrid = [
  ...
  {
    field: "ReportsTo",
    headerText: "سوپروایزر",
    width: "120",
    textAlign: "Center",
  },
  {
    field: "EmployeeID",
    headerText: "کد شناسایی",
    width: "125",
    textAlign: "Center",
  },
];
...
export const cartData = [
  ...
  {
    image: product9,
    name: "آبنبات چوبی با طعم توت فرنگی",
    category: "کالا های سوپرمارکتی",
    price: "۵۰٫۰۰۰﷼",
  },
];
...
export const chatData = [
  {
    image: avatar3,
    message: "آرمان به تیم پیوست!",
    desc: "خوش آمد بگویید.",
    time: "9:08 AM",
  },
  {
    image: avatar2,
    message: "پیام جدید دریافت شد.",
    desc: "سارا یک پیام جدید برای شما فرستاده است. ",
    time: "11:56 AM",
  },
  {
    image: avatar4,
    message: "پرداخت جدید انجام گرفت.",
    desc: "حساب خود را چک کنید",
    time: "4:39 AM",
  },
  {
    image: avatar,
    message: "محسن وظایف خود را به پایان رساند.",
    desc: "وظایف جدید واگذار کنید.",
    time: "1:12 AM",
  },
];
...
export const recentTransactions = [
  ...
  },
  {
    ...
    amount: "+۵٫۳۳۳٫۰۰۰﷼",
    title: "حساب پس انداز",
    desc: "واریز وجه به حساب بلند مدت ",
    iconColor: "rgb(255, 244, 229)",
    iconBg: "rgb(254, 201, 15)",
...
export const weeklyStats = [
  ...
  },
  {
    icon: <FiStar />,
    amount: "-۱۲٫۰۰۰٫۰۰۰﷼",
    title: "محبوب ترین فروش ها ",
    desc: "شرکت تن آسای غرب",
    iconBg: "rgb(254, 201, 15)",
    pcColor: "red-600",
  },
  {
...
export const productsPerformance = [
  {
    image: product5,
    title: "بستنی کیلویی ۵ ستاره",
    desc: "بستنی وانیلی میهن ۱ کیلیویی ۵ ستاره ",
    rating: "عالی",
    itemSold: "۷۵٪",
    earningAmount: "۲۳۰٫۰۰۰﷼",
  },
  {
    image: product6,
    title: "گوجه فرنگی تازه ",
    desc: "میوه فروشی وحید",
    rating: "درجه یک",
    itemSold: "۹۸٪",
    earningAmount: "۷۸۰٫۰۰۰﷼",
  },
  {
    image: product7,
    title: "آبنبات قرمز شیرین عسل ",
    desc: "آبنبات شکلاتی با روکش توت فرنگی شیرین عسل",
    rating: "متوسط",
    itemSold: "۴۶٪",
    earningAmount: "۴۰۰٫۰۰۰﷼",
  },
  {
    image: product4,
    title: "آباژور کنار تخت",
    desc: "آباژور طرح آدمک کنار تخت",
    rating: "ضعیف",
    itemSold: "۲۳٪",
    earningAmount: "۱۰۰٫۰۰۰﷼",
  },
];
...
export const ordersData = [
  ...
  },
  {
    ...
    CustomerName: "لیلا",
    TotalAmount: 17.99,
    OrderItems: "کرم مرطوب کننده پوست",
    Location: "کرمانشاه",
    Status: "در حال پردازش",
    StatusBg: "#03C9D7",
...
export const pieChartData = [
  { x: "نیروی انسانی", y: 18, text: "۱۸٪" },
  { x: "خقوقی", y: 8, text: "۸٪" },
  { x: "تولید", y: 15, text: "۱۵٪" },
  { x: "محوز", y: 11, text: "۱۱٪" },
  { x: "تاسیسات", y: 18, text: "۱۸٪" },
  { x: "مالیات", y: 14, text: "۱۴٪" },
  { x: "بیمه", y: 16, text: "۱۶٪" },
];
...
export const kanbanData = [
  ...
  },
  {
    ...
    Status: "Open",
    Summary:
      "مورد نیاز و کاربردهای متنوع با هدف بهبود ابزارهای کاربردی می باشد. کتابهای زیادی در شصت و سه درصد گذشته، حال و آینده شناخت فراوان جامعه و متخصصان را می طلبد تا با نرم افزارها شناخت بیشتری را برای طراحان رایانه ای",
    Type: "Others",
    Priority: "Critical",
    Tags: "Meeting",
    Estimate: 5.5,
...
export const PyramidData = [
  { x: "روغن و چربی", y: 120, text: "۱۲۰ کالری" },
  { x: "شیر و لبنیات", y: 435, text: "۴۳۵ کالری" },
  { x: "سبزیچات", y: 470, text: "۴۷۰ کالری" },
  { x: "گوشت قرمز، گوشت مرغ، ماهی", y: 475, text: "۴۷۵ کالری" },
  { x: "میوه", y: 520, text: "۵۲۰ کالری" },
  { x: "نان، برنج، پاستا", y: 930, text: "۹۳۰ کالری" },
];
